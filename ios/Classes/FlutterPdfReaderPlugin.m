#import "FlutterPdfReaderPlugin.h"

static NSString* const kDirectory = @"FlutterPluginPdfViewer";
static NSString* const kFilePath = @"file:///";
static NSString* kFileName = @"";

@implementation FlutterPdfReaderPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"com.beninsapps.flutter_pdf_reader"
            binaryMessenger:[registrar messenger]];
  FlutterPdfReaderPlugin* instance = [[FlutterPdfReaderPlugin alloc] init];
