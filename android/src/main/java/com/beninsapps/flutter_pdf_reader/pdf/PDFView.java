 ...
 */
package com.beninsapps.flutter_pdf_reader.pdf;
...
import com.beninsapps.flutter_pdf_reader.FlutterPdfReaderPlugin;
import com.beninsapps.flutter_pdf_reader.R;
import com.beninsapps.flutter_pdf_reader.pdf.exception.PageRenderingException;
import com.beninsapps.flutter_pdf_reader.pdf.listener.OnDrawListener;
import com.beninsapps.flutter_pdf_reader.pdf.listener.OnErrorListener;
import com.beninsapps.flutter_pdf_reader.pdf.listener.OnLoadCompleteListener;
import com.beninsapps.flutter_pdf_reader.pdf.listener.OnPageChangeListener;
import com.beninsapps.flutter_pdf_reader.pdf.listener.OnPageErrorListener;
import com.beninsapps.flutter_pdf_reader.pdf.listener.OnPageScrollListener;
import com.beninsapps.flutter_pdf_reader.pdf.listener.OnRenderListener;
import com.beninsapps.flutter_pdf_reader.pdf.listener.OnTapListener;
import com.beninsapps.flutter_pdf_reader.pdf.model.PagePart;
import com.beninsapps.flutter_pdf_reader.pdf.scroll.ScrollHandle;
import com.beninsapps.flutter_pdf_reader.pdf.source.AssetSource;
import com.beninsapps.flutter_pdf_reader.pdf.source.ByteArraySource;
import com.beninsapps.flutter_pdf_reader.pdf.source.DocumentSource;
import com.beninsapps.flutter_pdf_reader.pdf.source.FileSource;
import com.beninsapps.flutter_pdf_reader.pdf.source.InputStreamSource;
import com.beninsapps.flutter_pdf_reader.pdf.source.UriSource;
import com.beninsapps.flutter_pdf_reader.pdf.util.ArrayUtils;
import com.beninsapps.flutter_pdf_reader.pdf.util.Constants;
import com.beninsapps.flutter_pdf_reader.pdf.util.MathUtils;
import com.beninsapps.flutter_pdf_reader.pdf.util.Util;
...
import static com.beninsapps.flutter_pdf_reader.FlutterPdfReaderPlugin.eventSink;
...
public class PDFView extends RelativeLayout {
    ...
    public void moveTo(final float offsetX, final float offsetY) {
        ...
        if (eventSink != null)
            eventSink.success(new HashMap<String, Float>() {{
                put("XOffset",offsetX);
                put("YOffset",offsetY);
            }});
    }
    ...
    public void zoomTo(final float zoom) {
        this.zoom = zoom;
        if (eventSink != null)
            eventSink.success(new HashMap<String, Float>() {{put("Zoom",zoom);}});
    }
