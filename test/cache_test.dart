...
import 'package:flutter_pdf_reader/src/advanced_network_image/src/disk_cache.dart';
    ...
    test('=> save and load', () async {
      ...
      expect(
        await DiskCache().save('ddd'.hashCode.toString(),
            Uint8List.fromList(utf8.encode('to')), CacheRule(checksum: true)),
        true,
      );
      expect(
        await DiskCache().save(
            'eee'.hashCode.toString(),
    ...
    test('=> reach maxEntries', () async {
      ...
      expect(
        await DiskCache().save('ggg'.hashCode.toString(),
            Uint8List.fromList(utf8.encode('summer')), CacheRule()),
        true,
      );
      expect(
        await DiskCache().save('hhh'.hashCode.toString(),
            Uint8List.fromList(utf8.encode('autumn')), CacheRule()),
        true,
      );
    ...
    test('=> reach maxSizeBytes', () async {
      ...
      expect(
        await DiskCache().save('iii'.hashCode.toString(),
            Uint8List.fromList(utf8.encode('winter')), CacheRule()),
        true,
      );
      expect(
        await DiskCache().save('jjj'.hashCode.toString(),
            Uint8List.fromList(utf8.encode('Monday')), CacheRule()),
        true,
      );
    ...
    test('=> evict uid', () async {
      expect(
        await DiskCache().save('kkk'.hashCode.toString(),
            Uint8List.fromList(utf8.encode('Tuesday')), CacheRule()),
        true,
      );
    ...
    test('=> clear cache', () async {
      expect(
        await DiskCache().save('lll'.hashCode.toString(),
            Uint8List.fromList(utf8.encode('Wednesday')), CacheRule()),
        true,
      );
    ...
    test('=> get cache size', () async {
      ...
      expect(
        await DiskCache().save('mmm'.hashCode.toString(),
            Uint8List.fromList(utf8.encode('Thursday')), CacheRule()),
        true,
      );
      expect(
        await DiskCache().save(
    ...
    test('=> keep cache health', () async {
      ...
      expect(
        await DiskCache().save('ooo'.hashCode.toString(),
            Uint8List.fromList(utf8.encode('Saturday')), CacheRule()),
        true,
      );
