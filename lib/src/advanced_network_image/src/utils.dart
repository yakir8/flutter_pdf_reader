        ...
        onDone: () {
          ...
          if (buffer == null) {
            ...
            resultData = ((buffer!.length == bufferPosition)
                ? buffer : Uint8List.view(buffer!.buffer, 0, bufferPosition))!;
          }
...
class DoubleTween extends Tween<double> {
  DoubleTween({required double begin,required double end}) : super(begin: begin, end: end);
...
class OffsetTween extends Tween<Offset> {
  OffsetTween({required Offset begin,required Offset end}) : super(begin: begin, end: end);
