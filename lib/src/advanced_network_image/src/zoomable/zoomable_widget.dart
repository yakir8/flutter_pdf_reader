...
class _ZoomableChildState extends AnimatedWidgetBaseState<_ZoomableChild> {
  ...
  void forEachTween(visitor) {
    _zoom = visitor(
        _zoom, widget.zoom, (dynamic value) => DoubleTween(begin: value, end: 0)) as DoubleTween?;
    _panOffset = visitor(_panOffset, widget.panOffset,
        (dynamic value) => OffsetTween(begin: value, end: Offset.zero)) as OffsetTween?;
    _rotation = visitor(_rotation, widget.rotation,
        (dynamic value) => DoubleTween(begin: value, end: 0)) as DoubleTween?;
  }
